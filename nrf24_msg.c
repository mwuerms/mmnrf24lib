...
nrf24_msg_in_parse_t nrf24_msg_in_cb = NULL;

void nrf24_msg_init(nrf24_msg_in_parse_t msg_in_cb) {
	if(msg_in_cb) {
		nrf24_msg_in_cb = msg_in_cb;
	}
...
void nrf24_msg_send_remote_ctrl01(int8_t x0, int8_t y0, uint8_t btn0) {
	nrf24_msg_t m;
	m.id = nRF24_MSG_ID_ANSWER_REMOTE_CTRL01;
